<nav class="sidebar-nav">
    <ul id="sidebarnav">
        ...
        <!-- //BATAS SATU MENU -->
        <li>
            <a class="waves-effect waves-dark" href="<?php echo base_url()?>admin"><i class="mdi mdi-gauge">
            </i><span class="hide-menu">Home</span></a>
        </li>
        <li>
            <a class="waves-effect waves-dark" href="<?php echo base_url()?>admin/sinopsis"><i class="mdi mdi-gauge">
            </i><span class="hide-menu">Sinopsis</span></a>
        </li>
        <!-- //BATAS SATU MENU -->
